(function () {
  ...
  function downloadPdf(certificate, threshold) {
    ...
    doc.setTextColor(75, 85, 99); doc.setFont('helvetica', 'normal'); doc.setFontSize(11); const statement = `This certifies successful completion of the complete PhishAware assessment across all six phishing threat categories at or above the required passing standard of ${threshold}%.`; doc.text(doc.splitTextToSize(statement, 190), 148.5, 67, { align: 'center' });
